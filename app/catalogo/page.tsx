  ...
  return (
    <main className="min-h-screen px-6 py-10 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-6xl">
        <div className="rounded-[2rem] border border-[color:var(--line)] bg-[color:var(--panel)] p-7 shadow-[var(--shadow)] backdrop-blur sm:p-9">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.34em] text-[color:var(--accent)]">
                Eliza
              </p>
              <h1 className="mt-3 text-4xl font-semibold tracking-[-0.05em] text-[color:var(--primary)] sm:text-6xl">
                Catalogo
              </h1>
        ...
        {source === "fallback" ? (
          <div className="mt-8 rounded-[1.5rem] border border-dashed border-[color:var(--line-strong)] bg-[color:var(--panel-strong)] px-5 py-4 text-sm leading-7 text-[color:var(--ink)]/78 shadow-[0_10px_30px_rgba(7,7,5,0.04)]">
